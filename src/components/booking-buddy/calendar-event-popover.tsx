...
// not one blob.
export const MONTH_EVENT_CLASS = `block w-full overflow-hidden rounded-[3px] border border-[color-mix(in_oklch,var(--bb-ink-pen),transparent_45%)] bg-[color-mix(in_oklch,var(--bb-ink-pen),transparent_78%)] px-1.5 py-0.5 text-[12px] font-medium text-[color-mix(in_oklch,var(--bb-ink-pen),black_18%)] shadow-[0_1px_0_color-mix(in_oklch,var(--bb-ink-pen),transparent_82%)]`;

export const AGENDA_EVENT_CLASS =
  "flex w-full items-center gap-3 rounded-[3px] bg-[color-mix(in_oklch,var(--bb-ink-pen),transparent_90%)] px-3 py-2 text-sm hover:bg-[color-mix(in_oklch,var(--bb-ink-pen),transparent_84%)]";
