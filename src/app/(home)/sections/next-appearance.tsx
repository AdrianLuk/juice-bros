...
export function NextAppearance() {
  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
      <Link
        href="/appearances"
        className="group mx-auto flex w-fit max-w-full items-center gap-2.5 rounded-full border border-brand-orange/25 bg-brand-orange/5 px-5 py-2.5 text-sm transition-colors duration-300 hover:bg-brand-orange/10"
      >
