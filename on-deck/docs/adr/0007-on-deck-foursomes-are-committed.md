...
**Consequence.** The pre-start On Deck cards change as the room fills. That is honest — nothing has started — but it means a Player who glances at the board at 18:50 may not be on it at 18:55. Only Players behind the anchor can move, and while the Queue is short enough for Match Me's window to reach all of it (ADR 0004), a Player who has just arrived can be picked onto a card ahead of one who arrived earlier. That is the ordinary windowed selection this app has always done, not a new unfairness; before this amendment it was simply frozen out of the pre-start window by commitment. The turn notification is suppressed until the night starts for the same reason: "head to the courts" is wrong advice while every Court is empty, and buzzing each revision of a prediction would be noise.
