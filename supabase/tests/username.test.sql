...
insert into auth.users (id, instance_id, aud, role, email) values
  ('bbbbbbbb-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'ben.baseline@example.com');
...
insert into auth.users (id, instance_id, aud, role, email, raw_user_meta_data) values
  ('cccccccc-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'amy2@example.com', '{"display_name": "Amy Ace"}'::jsonb);
...
select throws_ok(
  $$update public.profiles set username = 'benbaseline'
    where id = 'aaaaaaaa-0000-0000-0000-000000000001'$$,
  null, null,
...
select is(
  (select count(*)::int from public.search_users('benbaseline')),
  1,
